...
static void standardize(double *x, double *y, double *x2, double *yx, 
                        ...
                        NumericVector &shift, double *scale, 
...
static void postprocess(double *w, double *shift, double *scale, 
...
List COPY_sparse_svm(NumericVector &lambda, double *x, const NumericVector &y, 
